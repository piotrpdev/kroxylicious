...
class VirtualClusterChangeDetectorTest {
    ...
    void detectsClusterAddingItsFilterChain() {
        ...
        var oldConfig = new Configuration(null, null, null, null, null, List.of(oldVc), null, false, Optional.empty(), null, null, null);
        var newConfig = new Configuration(null, null, List.of(filterDef("filter-a")), null, null, List.of(newVc), null, false, Optional.empty(), null, null, null);
        var result = detector.detect(new ConfigurationChangeContext(oldConfig, newConfig));
        assertThat(result.clustersToModify()).containsExactly("cluster");
    }
    ...
    void detectsClusterRemovingItsFilterChain() {
        ...
        var newVc = new VirtualCluster("cluster",
                ...
                List.of(gateway("default", 9192)),
                false, false, List.of());
        var oldConfig = new Configuration(null, null, List.of(filterDef("filter-a")), null, null, List.of(oldVc), null, false, Optional.empty(), null, null, null);
        var newConfig = new Configuration(null, null, null, null, null, List.of(newVc), null, false, Optional.empty(), null, null, null);
        var result = detector.detect(new ConfigurationChangeContext(oldConfig, newConfig));
        assertThat(result.clustersToModify()).containsExactly("cluster");
    }
